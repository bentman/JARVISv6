...
from backend.app.models.catalog import load_stt_catalog
...
def main() -> int:
    ...
    parser.add_argument("--family", required=True, choices=["stt"])
    ...
    for model_name, entry in targets:
        ...
        try:
            ensure_model(hf_repo_id=hf_repo_id, local_dir=local_dir)
